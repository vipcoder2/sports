          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-10">
            ...
            <div className="col-span-1 sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                ...
                the thrill of live sports from anywhere, anytime. We offer free
                live streams for football, soccer, basketball, cricket, and
                more.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  { name: "Blog", href: "https://blog.sportsbite.cc" },
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  { name: "Ice Hockey", href: "https://livefooty.online/" },
                  { name: "Baseball", href: "https://streambuddy.live/" },
                  { name: "Darts", href: "https://www.soccertvhd.com/" },
                  { name: "Other", href: "https://www.sportsbite.cc/" },
                  { name: "Rugby", href: "http://www.hesgoal.com/" },
                ].map((item) => (
                  <li key={item.name}>
                    <a
                      href={item.href}
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-6">
              <p className="text-sm text-muted-foreground">
                © 2024 Sports Bite. All rights reserved.
              </p>
