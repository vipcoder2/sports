...
export default function FootballSchedule() {
  ...
  // Football page SEO
  useEffect(() => {
    document.title = "Live Football on TV for FREE";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Watch free football live streams online. Premier League, Champions League, La Liga and all soccer matches in HD quality on Sportsbite.');
    }

    const canonical = document.querySelector('link[rel="canonical"]') || document.createElement('link');
    canonical.setAttribute('rel', 'canonical');
    canonical.setAttribute('href', 'https://sportsbite.cc/schedule/football');
