    ...
    <div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Monitor the health and status of Sportsbite API services</p>
        </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  <CardTitle>Sportsbite API</CardTitle>
                </div>
                {isLoading ? (
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={endpoint} className="p-3 rounded-lg border border-border">
                    <div className="flex items-center justify-between mb-1">
                      <code className="text-sm font-mono text-accent">{endpoint}</code>
